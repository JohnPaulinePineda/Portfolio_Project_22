...
|
| **[A]** The k-means algorithm was implemented only for descriptors using the <span style="color: #FF0000">stats</span> package.  
|
...
|
| **[A]** The partitioning around medoids algorithm was implemented only for descriptors using the <span style="color: #FF0000">cluster</span> package.  
|
...
|
| **[A]** The fuzzy analysis clustering algorithm was implemented only for descriptors using the <span style="color: #FF0000">cluster</span> package.  
|
...
|
| **[A]** The hierarchical clustering algorithm was implemented only for descriptors using the <span style="color: #FF0000">factoextra</span> package.  
|
| **[B]** The optimal number of clusters was 3 to 4 as determined using the average silhouette width, total within sum of squares and gap statistic.
|
...
|
| **[A]** The agglomerative nesting algorithm was implemented only for descriptors using the <span style="color: #FF0000">cluster</span> package.  
|
| **[B]** The optimal number of clusters was 3 as determined using the average silhouette width, total within sum of squares and gap statistic.
|
| **[C]** Using a fixed number of clusters equal to 3, the average silhouette width was determined to be 0.08172.
...
|
| **[A]** The divisive analysis clustering algorithm was implemented only for descriptors using the <span style="color: #FF0000">cluster</span> package.  
|
| **[B]** The optimal number of clusters was 3 as determined using the average silhouette width, total within sum of squares and gap statistic.
|
...
| **[Publication]** [A Review of Clustering Techniques and Developments](https://www.sciencedirect.com/science/article/abs/pii/S0925231217311815) by Amit Saxena (Neurocomputing)
